...
function Educate() {
  return (
    <section
      id="educate"
      className="w-[95%] mx-auto rounded-xl bg-[#3c4043] p-5 grid grid-cols-2"
    >
      <div className="flex flex-col justify-start items-start gap-3 bg-[#3c4043]">
        <h1 className="text-start capitalize bg-[#3c4043] pl-7 font-bold text-xl">Know your rights!</h1>
      ...
      <div className="hidden md:rounded-md">
