...
function Hero() {
  return (
    <section id='Hero' className='w-[90%] mx-auto p-5 flex flex-col items-center justify-center gap-3 md:gap-2'>
      <h1 className='text-3xl md:text-6xl lg:text-8xl capitalize text-center'>Justice served right.</h1>
      <h1 className='text-3xl md:text-6xl lg:text-8xl capitalize text-center'><span className='text-blue-500'>Verdict</span>  is here!</h1>
      <Link to="/login">
